package com.xuefei.spring.aop.selectProxy;
...
/**
 * @description: Spring-选择代理
 * @author: xuefei
 * @date: 2022/04/09 19:52
 */
public class SpringSelectProxy {
    public static void main(String[] args) {
        ...
        SpringSelectProxy.Target2 proxy = (SpringSelectProxy.Target2) factory.getProxy();
